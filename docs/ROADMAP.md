...
| Status | Meaning |
| --- | --- |
| ✅ Done | Implemented and usable in the app. |
...
| 5.8 | Bracket colorization and indent guides | P2 | ✅ Done | Monaco options are wired through settings. |
...
| 7.1 | Trim whitespace and final newline | P2 | ✅ Done | Formatting hygiene settings are available. |
...
| 7.5 | Go to line | P2 | ✅ Done | Provided by Monaco. |
| 7.6 | Multi-cursor and column selection | P2 | ✅ Done | Provided by Monaco. |
...
2. Problems panel.
3. Last cursor/view-state persistence.
4. SQLite schema migration cleanup.
...
1. NPM scripts panel.
2. Browser Preview auto-detection.
3. Tailwind and CSS tooling.
4. REST Client basics.

### Sprint 4 — AI workflow

1. Selected-code context in AI chat.
2. Inline completions.
3. Quick actions.
4. Tool-using AI agent with confirmations.

### Sprint 5 — distribution and reliability

1. CI pipeline.
2. Auto-update.
3. macOS and Linux build validation.
4. Recovery storage.
